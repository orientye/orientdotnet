...
internal static class MatchAckKindResolver
{
    private static readonly IReadOnlyDictionary<string, ProtocolMessageKind> KindByPropertyName =
        new Dictionary<string, ProtocolMessageKind>(StringComparer.Ordinal)
        {
            ...
            [nameof(MatchAckMsg.BeginhandAckMsg)] = ProtocolMessageKind.BeginHandAck,
            [nameof(MatchAckMsg.RulerinfoAckMsg)] = ProtocolMessageKind.RulerInfoAck,
            [nameof(MatchAckMsg.RulerinfoexAckMsg)] = ProtocolMessageKind.RulerInfoExAck,
            [nameof(MatchAckMsg.PushroundrulerinfoAckMsg)] = ProtocolMessageKind.PushRoundRulerInfoAck,
            [nameof(MatchAckMsg.StageplayerorderchangedAckMsg)] = ProtocolMessageKind.StagePlayerOrderChangedAck,
            [nameof(MatchAckMsg.PushplayergamedataAckMsg)] = ProtocolMessageKind.PushPlayerGameDataAck,
            [nameof(MatchAckMsg.PushmatchactionAckMsg)] = ProtocolMessageKind.PushMatchActionAck,
