...
call :RunProtoc --plugin=protoc-gen-crpc.exe --crpc_out=../../Example/HelloWorld --proto_path=%PROTO_INCLUDE% --proto_path=../../CRpc/Rpc/CRpc/Protobuf --proto_path=../../Example/HelloWorld helloworld.proto
